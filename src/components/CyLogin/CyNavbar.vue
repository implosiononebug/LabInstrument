<template>
  <el-menu :default-active="activeIndex"
    ...
    <el-menu-item class="logo-setting noBackground">
      CodeManLab
    </el-menu-item>
    <el-menu-item class="icon-cancelPadding">
      <el-dropdown>
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <div class="popper-width dropdown-scrollable">
            <ul class="media-list">
              <li class="media">
                <div class="mr-3">
                  <el-avatar class="icon-git-style"
                             icon="icon-git-pull-request"></el-avatar>
                </div>
              ...
              <li class="media">
                <div class="mr-3">
                  <el-avatar class="icon-git-commit-style"
                             icon="icon-git-commit"></el-avatar>
                </div>
                <div class="media-body">
                  <div class="media-title">
              ...
              <li class="media">
                <div class="mr-3">
                  <el-avatar class="icon-git-merge-style"
                             icon="icon-git-merge"></el-avatar>
                </div>
                <div class="media-body">
                  <div class="media-title">
          ...
          <div class="popper-width pt-2 pb-2 border-top">
            <el-link class="text-muted"
                     type="info"
                     :underline="false">所有更新</el-link>
            <div class="updated-icon-group">
              <el-tooltip class="item cancelPadding"
                          effect="dark"
    ...
    <el-menu-item class="float-right icon-cancelPadding mr-3 navbar-user-box">
      <el-dropdown>
        <div class="el-dropdown-link ">
          <el-avatar class="ml-3"
                     :size="34"></el-avatar>
          <span class="icon-color ml-3 navbar-user-name">{{ username }}</span>
    ...
    <el-menu-item class="float-right icon-cancelPadding">
      <el-dropdown>
        <div class="el-dropdown-link">
          <i class="icon-bubbles4 navbar-iconSize icon-color"></i>
        </div>
        <el-dropdown-menu slot="dropdown">
          <div class="media popper-width border-bottom">
            ...
            <ul class="media-list">
              <li class="media">
                ...
                <div class="media-body">
                  <div class="media-title">
                    <a href="#">
                      <span class="font-weight-semibold boot-primary">刘总</span>
                      <span class="text-muted font-size-sm float-right">16:46</span>
                    </a>
                  </div>
                  <span class="text-muted">
          ...
          <el-tooltip class="item pb-1 border-top"
                      effect="dark"
                      content="查看更多信息"
                      placement="top">
    ...
    <el-menu-item class="float-right icon-cancelPadding">
      <el-dropdown>
        <div class="el-dropdown-link">
          <i class="icon-people navbar-iconSize icon-color"></i>
        </div>
        <el-dropdown-menu slot="dropdown">
          <div class="media popper-width border-bottom">
            ...
            <ul class="media-list">
              ...
              <li class="media">
                ...
                <div class="media-body">
                  <div class="media-title">
                    <a href="#">
                      <span class="font-weight-semibold boot-primary">朱总</span>
                    </a>
                  </div>
                  <span class="text-muted">
                    老板
...
<style scoped src="../../assets/css/components/CyLogin/CyNavbar.css"></style>
<script>
