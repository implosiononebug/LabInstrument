        ...
        <el-card class="box-card" shadow="never">
          <el-tabs class="login-gruop" v-model="activeName" type="card" @tab-click="handleClick">
            ...
            <el-tab-pane label="账号密码" name="first">
              ...
              <el-row class="input-group">
                <el-button  @click="handleClickGetToken" class="btn btn-primary btn-block">
            ...
            <!--  账号登陆部分结束 -->
            <!-- 动态登陆部分 -->
            <el-tab-pane label="动态密码" name="second">
              <div class="login-title">
                <i class="icon-reading icon-2x text-slate-300 border-slate-300 border-3 rounded-round p-3 mb-3 mt-1 user-img"></i>
                <p>登陆账户</p>
              ...
              <el-row class="input-telphone-group">
                <input class="input-control" type="text" placeholder="验证码">
                <div class="input-icon-container" >
                  <i class="input-icon icon-iphone text-muted"></i>
                </div>
                <el-button type="primary" size="mini" class="button-primary">
                  获取验证码
                </el-button>
              </el-row>
              <el-row class="input-group">
            ...
            <el-row class="register-group">
              ...
              <el-link class="elem-primary" type="primary" :underline="false">忘记密码?</el-link>
            </el-row>
            <el-row>
              <a href="#" class="elem-primary font-size-sm ">Forgot password?</a>
            </el-row>
          </el-tabs>
        </el-card>
